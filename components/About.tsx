				...
				<div className='flex flex-col lg:flex-row items-center justify-between'>
					<div className='lg:w-[65%] mb-10 md:mb-0 md:pr-10 relative'>
						...
						<p className='text-gray-600 mb-4'>
							...
							участь сотні учасників, провела десятки майстер-класів з
							екстремальних прийомів для вокалістів і тренерів, випустила власну
							збірку вокальних вправ у стилі рок під назвою «ROCK ETUDES».
						</p>
						<p className='text-gray-600 mb-4'>
